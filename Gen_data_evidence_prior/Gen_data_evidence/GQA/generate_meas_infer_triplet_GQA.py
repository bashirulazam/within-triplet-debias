...
results = torch.load('checkpoints/trained_causal_motif_sgdet_gqa/inference/GQA_filtered_test/eval_results.pytorch')
...
im_range = 'full'
save_file = 'data_rel_meas_infer_' + method + setting + 'GQA_' + im_range + '.mat'
